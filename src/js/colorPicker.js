...
const ColorPicker = {
    ...
    slider: {
        ...
        update() {
            ...
            rgb = ColorPicker.pickerCTX.getImageData(ColorPicker.picker.x, ColorPicker.picker.y, 1, 1).data;
            $id('colorPicker-picked')
    ...
    init() {
        // Set up canvas
        const c_1 = $id('colorPicker-canvasChooser');
        this.pickerCTX = c_1.getContext('2d');
        const c_2 = $id('colorPicker-canvasSlide');
        ...
        function pickerMouseEventHandler(ev) {
            if (ColorPicker.picker.mouseDown) {
                if (ev.composedPath()[0].id === 'colorPicker-chooser') {
        ...
        function sliderMouseEventHandler(ev) {
            if (ColorPicker.slider.mouseDown) {
                if (ev.composedPath()[0].id === 'colorPicker-slide') {
                    if (ev.offsetX > 0 && ev.offsetX <= 200) {
